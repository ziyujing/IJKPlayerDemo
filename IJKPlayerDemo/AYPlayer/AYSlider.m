...
@interface AYSlider ()<AYValuePoUpViewDelegate>
@property (strong, nonatomic) AYValuePoUpView *popUpView;
@property (nonatomic) BOOL popUpViewAlwaysOn; // default is NO
@end

@implementation AYSlider
{
...
- (void)setup
{
    ...
    self.popUpView = [[AYValuePoUpView alloc] initWithFrame:CGRectZero];
