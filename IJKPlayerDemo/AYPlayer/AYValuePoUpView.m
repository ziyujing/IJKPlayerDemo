...
@implementation CALayer (AYAnimationAdditions)
...
NSString *const AYSliderFillColorAnim = @"fillColor";

@implementation AYValuePoUpView
...
- (void)setColor:(UIColor *)color
{
    ...
    [_colorAnimLayer removeAnimationForKey:AYSliderFillColorAnim]; // single color, no animation required
}
...
- (void)setAnimatedColors:(NSArray *)animatedColors withKeyTimes:(NSArray *)keyTimes
{
    ...
    CAKeyframeAnimation *colorAnim = [CAKeyframeAnimation animationWithKeyPath:AYSliderFillColorAnim];
...
//    colorAnim.delegate = self;
    ...
    [_colorAnimLayer addAnimation:colorAnim forKey:AYSliderFillColorAnim];
}

- (void)setAnimationOffset:(CGFloat)animOffset returnColor:(void (^)(UIColor *opaqueReturnColor))block
{
    if ([_colorAnimLayer animationForKey:AYSliderFillColorAnim]) {
